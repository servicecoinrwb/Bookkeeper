...
export const UI = {
    ...
    switchTab(tabName) {
        ...
        if(target) {
            ...
            if(tabName === 'taxes') this.renderTaxes(); // Ensure render
    ...
    updateDashboard() {
        ...
        // Force Tax Update on Filter Change
        this.renderTaxes();
    },
    ...
    renderTaxes() {
        ...
        const selectedMonth = State.filters.month; // NEW: Respect Month

        // 1. Filter Transactions using Shared Logic
        ...
        ['q1','q2','q3','q4'].forEach(q => {
            ...
            if(el) {
                // If viewing a single month or all years, quarters might be confusing/N/A
                // For simplicity, we just divide the calculated tax by 4
