...
export const UI = {
    ...
    showToast(msg, type = 'success') {
        ...
        // CHANGED: "top-5" -> "bottom-5" to move it away from the header
    ...
    // ... (Keep renderAging, renderVendorReport, renderJobs, renderSimpleTable, renderGuide, updateReconCalc, switchReport, getReportSearchTerm, renderPL) ...
